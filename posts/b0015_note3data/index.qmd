...
La métaphore connait des limites, et si le pétrole se sert à la pompe, et se verse dans le réservoir, prêt à brûler, il ne suffit pas de les brûler pour en consommer la valeur. L'exemple simple et récent d'une [innovation d'Amazon](https://www.zdnet.com/article/amazon-now-using-generative-ai-to-summarize-customer-reviews/) , celle d'un nouveau service de recommandation, s'appuie sur une idée simple et géniale. Améliorer l'expérience client c'est réduire le cumul les avis que personne ne lit plus, en les résumant et en proposant au client une synthèse. L'intelligence artificielle servant d'estomac pour réduire les données et les rendre digestes.
